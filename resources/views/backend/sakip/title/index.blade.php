...
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-900">Manajemen Title</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="card-header pt-7">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-900">Data Title</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-7">Manajemen title jabatan SAKIP</span>
        </h3>
        <div class="card-toolbar">
            <button type="button" class="btn btn-sm btn-primary" onclick="addData()">
                <i class="ki-outline ki-plus fs-2"></i> Tambah Title
            </button>
        </div>
    </div>
    <div class="card-body">
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_title">
            <thead>
                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                    <th class="w-10px pe-2">No</th>
                    <th class="min-w-200px">Nama Title</th>
            ...
            <form id="kt_modal_form" class="ajax-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-7">
                        <label class="required fw-semibold fs-6 mb-2">Nama Title</label>
                        <input type="text" name="nama_title" id="nama_title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Contoh: Kepala Bidang" />
                    </div>
                </div>
...
@push('scripts')
<script>
    var table = $('#kt_table_title').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('sakip.title.index') }}",
        columns: [
    ...
    function editData(id) {
        $.get("{{ url('admin/sakip/title') }}/" + id + "/edit", function(data) {
            $('#data_id').val(data.reftitle_id);
            $('#nama_title').val(data.nama_title);
