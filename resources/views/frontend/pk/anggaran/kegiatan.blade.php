...
@section('title', 'Anggaran Kegiatan PK')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Anggaran Kegiatan PK</h1>
...
<script>
    ...
    function initDataTable() {
        dt = $('#kt_datatable_anggaran').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('frontend.pk.anggaran-kegiatan.data') }}",
                data: function(d) {
            ...
            drawCallback: function(settings) {
                ...
                api.column(1, { page: 'current' }).data().each(function(group, i) {
                    if (last !== group) {
                        $(rows).eq(i).before(
                            '<tr class="group bg-light-info"><td colspan="3" class="fw-bolder text-gray-800 fs-6 py-3">Program: ' + group + '</td></tr>'
                        );
                        last = group;
                    }
                });
