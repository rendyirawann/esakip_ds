...
@section('title', 'Target PK Triwulan Indikator Kegiatan')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Target PK Triwulan Indikator Kegiatan</h1>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $.get("{{ url('frontend/pk/kegiatan-triwulan') }}/" + id + "/edit", function(res) {
        ...
        $('#form_edit').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('frontend.pk.kegiatan.triwulan.store') }}",
                type: "POST",
                data: $(this).serialize(),
    ...
    function initDataTable() {
        dt = $('#kt_datatable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('frontend.pk.kegiatan.triwulan.data') }}",
                data: function(d) {
