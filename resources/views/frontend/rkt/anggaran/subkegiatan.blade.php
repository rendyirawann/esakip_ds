...
@section('title', 'Anggaran Sub Kegiatan RKT')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Anggaran Sub Kegiatan RKT</h1>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div id="empty_state" class="card shadow-sm {{ $current_skpd && $current_periode ? 'd-none' : '' }}">
                <div class="card-body p-20 text-center">
                    <img src="{{ asset('assets-front/media/illustrations/sketchy-1/19.png') }}" class="mw-350px mb-10" alt="Illustration" />
                    ...
                    <table id="kt_datatable_anggaran" class="table align-middle table-row-dashed fs-6 gy-5">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-200px">Anggaran RKT</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit-anggaran', function() {
            ...
            const input = $(`.input-anggaran-rkt[data-id="${id}"]`);
            
            // Masuk mode edit
            input.prop('readonly', false).removeClass('bg-light').focus();
            
            // Ganti tombol Edit jadi tombol Simpan & Batal
        ...
        $(document).on('click', '.btn-save-anggaran', function() {
            ...
            $.ajax({
                url: "{{ route('frontend.rkt.anggaran-subkegiatan.update') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
    ...
    function initDataTable() {
        dt = $('#kt_datatable_anggaran').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('frontend.rkt.anggaran-subkegiatan.data') }}",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'anggaran_rkt_input', name: 'anggaran_rkt_input', className: 'text-end', orderable: false, searchable: false },
                { 
                    data: null, 
