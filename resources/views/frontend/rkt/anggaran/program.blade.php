...
@section('title', 'Anggaran Program RKT')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Anggaran Program RKT</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark">Anggaran Program</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 shadow-sm">
                <div class="card-body">
                    <form action="{{ route('frontend.rkt.anggaran-program.filter') }}" method="POST" id="filter_form" class="no-loader">
                        @csrf
                    ...
                    <table id="kt_datatable_anggaran" class="table align-middle table-row-dashed fs-6 gy-5">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-250px">Program</th>
...
<script>
    ...
    function initDataTable() {
        dt = $('#kt_datatable_anggaran').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('frontend.rkt.anggaran-program.data') }}",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'total_anggaran_rkt', name: 'total_anggaran_rkt', className: 'text-end fw-bold text-dark' }
            ],
            order: [[1, 'asc']], 
            drawCallback: function(settings) {
                ...
                api.column(1, { page: 'current' }).data().each(function(group, i) {
                    if (last !== group) {
                        $(rows).eq(i).before(
                            '<tr class="group bg-light"><td colspan="4" class="fw-bolder text-gray-800 fs-6 py-3">Sasaran Renstra: ' + group + '</td></tr>'
                        );
                        last = group;
                    }
                });
