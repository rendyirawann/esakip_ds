...
@section('title', 'Anggaran Kegiatan PK Perubahan')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Anggaran Kegiatan PK Perubahan</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark">Anggaran Kegiatan</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <table id="kt_datatable_anggaran" class="table align-middle table-row-dashed fs-6 gy-5">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-300px">Uraian Kegiatan</th>
                                ...
                                <th class="text-end min-w-150px">Anggaran PK P</th>
                            </tr>
                        </thead>
...
<script>
    ...
    function initDataTable() {
        dt = $('#kt_datatable_anggaran').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('frontend.pkp.anggaran-kegiatan.data') }}",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'total_anggaran_pk_p', name: 'total_anggaran_pk_p', className: 'text-end fw-bold text-success' }
            ],
            order: [[1, 'asc']],
