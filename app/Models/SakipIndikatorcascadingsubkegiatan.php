...
class SakipIndikatorcascadingsubkegiatan extends Model
{
    use HasFactory;

    protected $table = 'sakip_indikatorcascadingsubkegiatan';
    protected $primaryKey = 'refindikatorsubkegiatan_id';
    ...
    {
        return $this->belongsTo(SakipCascadingsubkegiatan::class, 'refcascadingsubkegiatan_id', 'refcascadingsubkegiatan_id');
    }
