...
class SakipPenjabatskpdCascadingkegiatan extends Model
{
    use HasFactory;

    protected $table = 'sakip_penjabatskpd_cascadingkegiatan';
    protected $primaryKey = 'refpenjabatcascadingkegiatan_id';
