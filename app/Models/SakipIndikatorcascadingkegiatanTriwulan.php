...
class SakipIndikatorcascadingkegiatanTriwulan extends Model
{
    use HasFactory;

    protected $table = 'sakip_indikatorcascadingkegiatan_triwulan';
    protected $primaryKey = 'refindikatorkegiatantriwulan_id';
