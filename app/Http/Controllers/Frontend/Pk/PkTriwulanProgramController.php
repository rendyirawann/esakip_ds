...
class PkTriwulanProgramController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.pk.triwulan.program', compact(
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('indikator', function($row) {
                return $row->uraian_indikatorprogram ?? '-';
            })
            ->addColumn('satuan', function($row) {
                return $row->program_satuan ?? '-';
            })
            ...
            ->addColumn('action', function($row) {
                return '<button type="button" class="btn btn-icon btn-light-primary btn-sm btn-edit" data-id="'.$row->refindikatorprogramtriwulan_id.'" title="Edit PK Triwulan">
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Data PK Triwulan Program berhasil disimpan!'
        ]);
    }
}
