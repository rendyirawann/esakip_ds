...
class PkpTriwulanSasaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.pkp.triwulan.sasaran', compact(
    ...
    public function data(Request $request)
    {
        ...
        $query = SakipIndikatorsasaranrenstraTriwulan::select(
                ...
                'sakip_indikatorsasaranrenstra.target_pk_p', 
        ...
        return DataTables::of($query)
            ...
            ->addColumn('target_pkp_tahunan', function($row) {
                return $row->target_pk_p ?? '-';
            })
            ->addColumn('target_pkp_triwulan', function($row) {
                return $row->triwulan_target_pk_p ?? '-';
            })
            ->addColumn('keterangan', function($row) {
                return $row->triwulan_keterangan_pk_p ?? '-';
            })
            ->addColumn('action', function($row) {
                return '<button type="button" class="btn btn-icon btn-light-primary btn-sm btn-edit" data-id="'.$row->refindikatorsasaranrenstratriwulan_id.'" title="Edit">
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Data PK Perubahan Triwulan berhasil disimpan!'
        ]);
    }
}
