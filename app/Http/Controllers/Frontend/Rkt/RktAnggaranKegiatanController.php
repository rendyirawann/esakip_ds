...
class RktAnggaranKegiatanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.rkt.anggaran.kegiatan', compact(
    ...
    public function data(Request $request)
    {
        ...
        $query = SakipCascadingkegiatan::select('refprogram_id', 'refkegiatan_id', 'refskpd_id', 'refperiode_id')
            ->with(['kegiatan', 'cascadingProgram.sasaranRenstra', 'program'])
        ...
        return DataTables::of($query)
            ...
            ->addColumn('uraian_sasaran', function($row) {
                return $row->cascadingProgram->sasaranRenstra->uraian_sasaranrenstra ?? '-';
            })
