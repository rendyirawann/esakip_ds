...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_indikatorcascadingprogram_triwulan', function (Blueprint $table) {
            $table->bigIncrements('refindikatorprogramtriwulan_id');
    ...
    {
        Schema::dropIfExists('sakip_indikatorcascadingprogram_triwulan');
    }
};