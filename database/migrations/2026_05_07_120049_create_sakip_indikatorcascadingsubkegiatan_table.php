...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_indikatorcascadingsubkegiatan', function (Blueprint $table) {
            $table->bigIncrements('refindikatorsubkegiatan_id');
            ...
            $table->text('anggaran_rkt')->nullable();
            $table->text('target_rkt_p')->nullable();
            $table->text('anggaran_rkt_p')->nullable();
            $table->text('target_pk')->nullable();
            $table->text('anggaran_pk')->nullable();
            $table->text('target_pk_p')->nullable();
            $table->text('anggaran_pk_p')->nullable();
    ...
    {
        Schema::dropIfExists('sakip_indikatorcascadingsubkegiatan');
    }
};