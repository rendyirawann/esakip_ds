...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_penjabatskpd_cascadingkegiatan', function (Blueprint $table) {
            $table->bigIncrements('refpenjabatcascadingkegiatan_id');
            ...
            $table->text('uraian_sasarankegiatan')->nullable();
            $table->text('uraian_indikatorkegiatan')->nullable();
            $table->text('kegiatan_target')->nullable();
            $table->text('kegiatan_satuan')->nullable();
    ...
    {
        Schema::dropIfExists('sakip_penjabatskpd_cascadingkegiatan');
    }
};