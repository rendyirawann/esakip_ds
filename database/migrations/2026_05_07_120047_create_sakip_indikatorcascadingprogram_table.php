...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_indikatorcascadingprogram', function (Blueprint $table) {
            $table->bigIncrements('refindikatorprogram_id');
    ...
    {
        Schema::dropIfExists('sakip_indikatorcascadingprogram');
    }
};