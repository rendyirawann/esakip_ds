...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_renstratujuan', function (Blueprint $table) {
            $table->bigIncrements('refrenstratujuan_id');
            $table->text('uraian_renstratujuan');
    ...
    {
        Schema::dropIfExists('sakip_renstratujuan');
    }
};