...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_indikatorsasaranrenstra_p_triwulan', function (Blueprint $table) {
            $table->bigIncrements('refindikatorsasaranrenstratriwulan_p_id');
            $table->bigInteger('refindikatorsasaranrenstra_p_id')->nullable();
    ...
    {
        Schema::dropIfExists('sakip_indikatorsasaranrenstra_p_triwulan');
    }
};