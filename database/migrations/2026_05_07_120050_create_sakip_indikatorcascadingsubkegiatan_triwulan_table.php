...
return new class extends Migration
{
    ...
    {
        Schema::create('sakip_indikatorcascadingsubkegiatan_triwulan', function (Blueprint $table) {
            $table->bigIncrements('refindikatorsubkegiatantriwulan_id');
            ...
            $table->text('triwulan_penyerapan_anggaran')->nullable();
    ...
    {
        Schema::dropIfExists('sakip_indikatorcascadingsubkegiatan_triwulan');
    }
};